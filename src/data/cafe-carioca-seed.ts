...
export const cafeCariocaTables: Table[] = [
  {
    ...
    label: "Balcão",
    code: "BALCAO",
    qrCodeUrl: "TODO_CONFIG_PUBLIC_BASE_URL/loja/cafe-carioca/mesa/balcao",
    isActive: true,
    createdAt: now,
  },
  {
    ...
    label: "Mesa 01",
    code: "MESA01",
    qrCodeUrl: "TODO_CONFIG_PUBLIC_BASE_URL/loja/cafe-carioca/mesa/mesa-01",
    isActive: true,
    createdAt: now,
  },
  {
    ...
    label: "Mesa 02",
    code: "MESA02",
    qrCodeUrl: "TODO_CONFIG_PUBLIC_BASE_URL/loja/cafe-carioca/mesa/mesa-02",
    isActive: true,
    createdAt: now,
  },
];
