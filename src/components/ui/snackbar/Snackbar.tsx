...
export function Snackbar({ message, onDismiss, placement = "bottom", variant = "success" }: SnackbarProps) {
  useEffect(() => {
  ...
  return (
    <div className={`snackbar snackbar--${variant} snackbar--${placement}`} role="status">
